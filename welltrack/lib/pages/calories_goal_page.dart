  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('calories', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w500)),
        centerTitle: true,
        actions: const [
          Padding(
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: CustomPaint(
                painter: _BarChartPainter(_mockData, color: const Color(0xFFB3B3FF)),
                child: Container(),
              ),
            ),
                ...
                children: [
                  ...
                  SliderTheme(
                    data: SliderTheme.of(context).copyWith(
                      ...
                      inactiveTrackColor: Color(0xFFB3B3FF).withOpacity(0.3),
